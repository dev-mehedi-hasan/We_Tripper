...
class Admin extends CI_Controller {
	...
	function booking_requests($param1 ='', $param2 = ''){
		...
		if($param1 == 'approved'){
			...
			redirect(site_url('admin/booking_requests'), 'refresh');
		}
		if($param1 == 'pending'){
			$data['status'] = 0;
			$this->db->where('id', $param2);
		...
		$page_data['page_name'] = 'booking_requests';
		$page_data['page_title'] = get_phrase('booking_requests');
		$this->load->view('backend/index.php', $page_data);
	}
