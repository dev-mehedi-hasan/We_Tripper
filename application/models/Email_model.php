...
class Email_model extends CI_Model {
	...
	public function flights_booking_mail($data = "") {
		$total_people = $data['adult_guests_for_booking'] + $data['child_guests_for_booking'];
		$departure_date = $data['departure_date'];
		$departure_time = $data['departure_time'];
		$subject 		= "Flights Booking Request at $departure_date time $departure_time";
		$email_msg	=	"<b>Hello,</b>";
		$email_msg	.=	"<p>I would like to book a ".$data['flights_cabin']." tickets for ". $total_people ." people. Adults in number is ".$data['adult_guests_for_booking']." and Child in number is ".$data['child_guests_for_booking'].".</p>";
		$email_msg	.=	"<p>I would like to book this at ".$departure_date." time ".$departure_time.". Please let me know from your side.</p>";
	...
	public function ship_booking_mail($data = "") {
		$total_people = $data['adult_guests_for_booking'] + $data['child_guests_for_booking'];
		$departure_date = $data['departure_date'];
		$departure_time = $data['departure_time'];
		$subject 		= "Ship Booking Request at $departure_date time $departure_time";
		$email_msg	=	"<b>Hello,</b>";
		$email_msg	.=	"<p>I would like to book a ".$data['ship_cabin']." tickets for ". $total_people ." people. Adults in number is ".$data['adult_guests_for_booking']." and Child in number is ".$data['child_guests_for_booking'].".</p>";
		$email_msg	.=	"<p>I would like to book this at ".$departure_date." time ".$departure_time.". Please let me know from your side.</p>";
	...
	public function tour_package_booking_mail($data = "") {
		$total_people = $data['adult_guests_for_booking'] + $data['child_guests_for_booking'];
		$subject 		= "Tour Package Booking Request";
		$email_msg	=	"<b>Hello,</b>";
		$email_msg	.=	"<p>I would like to book a ".$data['tour_package_service_type']." service of ". $total_people ." people. Adults in number is ".$data['adult_guests_for_booking']." and Child in number is ".$data['child_guests_for_booking'].".</p>";
	...
	public function car_rental_booking_mail($data = "") {
		$book_from = $data['book_from'];
		$book_to = $data['book_to'];
		$subject 		= "Rent a car Request from $book_from to $book_to";
		$email_msg	=	"<b>Hello,</b>";
		$email_msg	.=	"<p>I would like to rent this car. My pick up point is ".$data['car_rental_pick_up_point']." at ". $data['car_rental_pick_up_city'] .".</p>";
	...
	public function visa_booking_mail($data = "") {
		$subject 		= "Visa booking request for ".$data['visa_booking_country'];
		$email_msg	=	"<b>Hello,</b>";
		$email_msg	.=	"<p>I would like to have your help to get VISA for ".$data['visa_booking_country'].".I prefer to get a".$data['visa_booking_type']." Visa.</p>";
		$email_msg	.=	"<p>".$data['visa_booking_message']."</p>";
