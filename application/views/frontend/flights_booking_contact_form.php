<div class="price">
	<span class="contact"><?php echo get_phrase('book_air_ticket'); ?></span>
...
<div class="form-group clearfix">
	<div class="custom-select-form">
		<select class="wide" name="flights_cabin" required>
			<option value=""><?php echo get_phrase('flights_cabin'); ?></option>
