		...
		<div class="col-lg-8">
			<section id="description">
				...
				?>
					<hr>
				<?php 
				include 'hotel_listing_inner_page.php'; 
				endif; 
				?>

				<?php 
				if ($listing_details['listing_type'] == 'flights'): 
				?>
					<hr>
				<?php 
				include 'flights_listing_inner_page.php'; 
				endif; 
				?>
				<!-- /row -->
			...
			<aside class="col-lg-4" id="sidebar">
				<div class="box_detail booking">
					<form class="contact-us-form" action="<?php echo site_url('home/contact_us/'.$listing_details['listing_type']); ?>" method="post">
						...
						<?php elseif ($listing_details['listing_type'] == 'flights'): ?>
							<?php include 'flights_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'ship_ticket'): ?>
							<?php include 'ship_ticket_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'car_rental'): ?>
							<?php include 'car_rental_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'tour_package'): ?>
							<?php include 'tour_package_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'visa'): ?>
							<?php include 'visa_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'bus_ticket'): ?>
							<?php include 'bus_ticket_booking_contact_form.php'; ?>
						<?php elseif ($listing_details['listing_type'] == 'local_car'): ?>
							<?php include 'local_car_booking_contact_form.php'; ?>
						<?php else: ?>
