...
<section class="we_packages">
	<div class="bg_color_1">
		<div class="container margin_80_55">
			<div class="main_title_2">
				<span><em></em></span>
				<h2><?php echo get_phrase('Featured Hotels'); ?></h2>
				<p><?php echo get_phrase('All over the country'); ?>.</p>
			</div>
			<?php
			$hotel_listings = $this->frontend_model->get_featured_two_listing_hotels();
			foreach($hotel_listings as $listing):
			if(!has_package($listing['user_id']) > 0)
			continue;?>
			<div class="we_packages__package">
				<div class="packages__packageHeader">
					<img src="<?php echo base_url('uploads/listing_thumbnails/'.$listing['listing_thumbnail']); ?>" alt="hotel image" />
					<p class="packages__packageHeaderTitle">Hotel</p>
					<p class="packages__packageHeaderFeatured">Featured</p>
					<a href="javascript:void(0)" class="packages__packageHeaderWishlist">
					<span class="<?php echo strtolower(now_open($listing['id'])) == 'closed' ? 'loc_closed' : 'loc_open'; ?>"><?php echo now_open($listing['id']); ?></span>
					</a>
				</div>
				<div class="packages__packageBody">
					<div class="score">
						<span>
							<?php
					...
					<p class="ellipsis"><?php echo $listing['description']; ?></p>
					<div class="packages__packageBodyLocation">
					<a href="http://maps.google.com/maps?q=<?php echo $listing['latitude']; ?>,<?php echo $listing['longitude']; ?>" target="_blank">
							<img src="<?php echo base_url('assets/frontend/images/location.svg'); ?>" alt="hotel location">
							<p>Show on Map</p>
					</a>
					</div>
				</div>
...
<div class="container margin_80_55">
    <div class="main_title_2">
		<span><em></em></span>
		<h2><?php echo get_phrase('Trending Packages'); ?></h2>
		<p><?php echo get_phrase('Packages of the week'); ?>.</p>
	</div>
...
<?php
$package_listings = $this->frontend_model->get_top_three_package_listings();
foreach($package_listings as $listing):
	if(!has_package($listing['user_id']) > 0)
		continue; ?>
