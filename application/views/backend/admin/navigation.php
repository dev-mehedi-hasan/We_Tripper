<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- Bookings -->
        <li class="<?php if ($page_name == 'booking_requests' ) echo 'active'; ?>">
            <a href="<?php echo site_url('admin/booking_requests'); ?>">
        ...
        <!-- SETTINGS -->
        <li class="<?php
        if ($page_name == 'system_settings' || $page_name == 'frontend_settings' || $page_name == 'payment_settings' || $page_name == 'manage_language' || $page_name == 'smtp_settings' ) echo 'opened active'; ?> ">
        <a href="#">
