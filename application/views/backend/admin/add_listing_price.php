<div class="form-group">
  ...
  <div class="col-sm-7">
    <div class="form-group">
      <input type="text" class="form-control" id = "regular_price" name="regular_price"  style="width: 50%;"/>
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-sm-7">
    <div class="form-group">
      <input type="text" class="form-control" id = "sale_price" name="sale_price"  style="width: 50%;"/>
    </div>
  </div>
</div>