...
//new version
    var map = L.map(settings.mapId).setView([23.4905831, 88.1002603], 13);
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
        attribution: 'Map data &copy; <a href="https://dterms.com">DTerms Ltd.</a> contributors, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
        minZoom: 2,
        maxZoom: 18,
        id: 'mapbox/streets-v11',
        accessToken: 'pk.eyJ1IjoibWVoZWRpMDE2ODkiLCJhIjoiY2tsb3lhOWZrMGRjYTJwcW10aTU2ZDdvdSJ9.V9qtDOr3X8xby3U8xwS-Cg'
    }).addTo(map);
